...
f = h5py.File('../job/dyn-yaw-8wt-30-static/output/dyn-yaw-8wt-30-static_force.h5','r')
phase = f['phase'][901:,0,:,:]
time = f['time'][901:]
root_moment_flap = f['moment_flap'][901:,:,0,:]
...
f = h5py.File('../job/dyn-yaw-8wt-30-300s/output/dyn-yaw-8wt-30-300s_force.h5','r')
phase = f['phase'][901:,0,:,:]
time = f['time'][901:]
root_moment_flap = f['moment_flap'][901:,:,0,:]
